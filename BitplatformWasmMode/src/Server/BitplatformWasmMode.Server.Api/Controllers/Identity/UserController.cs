...
using BitplatformWasmMode.Shared.Controllers.Identity;

namespace BitplatformWasmMode.Server.Api.Controllers.Identity;
...
public partial class UserController : AppControllerBase, IUserController
{
    ...
    private string GenerateQrCodeUri(string user, string unformattedKey)
    {
        ...
        urlEncoder.Encode("bit platform BitplatformWasmMode"),
